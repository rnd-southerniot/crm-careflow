    ...
    <DayPicker
      ...
      components={{
        ...
        MonthGrid: ({ className, children, ...monthGridProps }) => (
          /* ✅ children passed as nested content instead of prop */
          <MonthGrid
            className={className}
            displayYears={displayYears}
            startMonth={startMonth}
...
function Nav({
  ...
  }, [navView, previousMonth, goToMonth, setDisplayYears, displayYears, onPrevClick]);
  ...
  }, [navView, nextMonth, goToMonth, setDisplayYears, displayYears, onNextClick]);
  ...
  return (
    <div className={cn("grid grid-cols-4 gap-y-2", className)} {...props}>
      {Array.from({ length: displayYears.to - displayYears.from + 1 }, (_, i) => {
        ...
        const isAfter = endMonth && differenceInCalendarDays(new Date(year, 0, 0), endMonth) > 0;
